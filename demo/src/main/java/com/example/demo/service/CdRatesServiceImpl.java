...
public class CdRatesServiceImpl implements CdRatesService {
	...
	public List<CdRatesDTO> getData(int zipCode) {
		...
		List<String> ids = getAllkey(zipCode);
		List<CdRates> cdRatesResponse = (List<CdRates>) cdRatesRepository.findAllById(ids);
	...
	public List<CdHistoryRatesDTO> getHistoryData(int zipCode) {
		...
		List<String> ids = getAllkey(zipCode);
		List<ArchiveCdRates> cdHisRatesResponse = (List<ArchiveCdRates>) cdArchiveRatesRepository.findAllById(ids);
